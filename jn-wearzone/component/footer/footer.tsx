...
import { FooterContainer, FooterWrap, FooterLinkWrapper, FooterLinkItems, FooterLinkContainer, FooterLinkTitle, FooterLink, SocialIconLink, SocialIcons, SocialLogo, SocialMedia, SocialMediaWrap, WebsiteRights } from './footerElement'
            ...
            <FooterWrap>
                ...
                <SocialMedia>
                    <SocialMediaWrap>
                        ...
                        <WebsiteRights>jnwearzone © {new Date().getFullYear()} All rights reserved.</WebsiteRights>
                        <SocialIcons>
